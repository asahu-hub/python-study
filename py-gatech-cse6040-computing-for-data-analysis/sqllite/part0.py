...
c.execute('DELETE from Takes')
conn.commit()

all_grades=[ (123, 'CSE 6040', 4.0 ), (123, 'ISYE 6644', 3.0 ), (123, 'MGMT 8803', 1.0 ), (991, 'CSE 6040', 4.0 ), (991, 'ISYE 6740', 4.0 ), (456, 'CSE 6040', 4.0 ), (456, 'ISYE 6740', 2.0 ), (456, 'MGMT 8803', 3.0 )]
c.executemany('INSERT INTO Takes VALUES (?, ?, ?)', all_grades)
conn.commit()
...
assert (123, 'CSE 6040', 4.0) in results, "Fail 1"
assert (123, 'ISYE 6644', 3.0) in results, "Fail 2"
assert (123, 'MGMT 8803', 1.0) in results, "Fail 3"
assert (991, 'CSE 6040', 4.0) in results, "Fail 4"
assert (991, 'ISYE 6740', 4.0) in results, "Fail 5"
assert (456, 'CSE 6040', 4.0) in results, "Fail 6"
assert (456, 'ISYE 6740', 2.0) in results, "Fail 7"
assert (456, 'MGMT 8803', 3.0) in results, "Fail 8"
